...
function jabber_get_rid_sid() {
    ...
    $xmlposts[] = "<body rid='" . jabber_get_next_rid() . "' xmlns='http://jabber.org/protocol/httpbind' sid='$_jabber_sid_'><iq type='set' id='_session_auth_2' xmlns='jabber:client'><session xmlns='urn:ietf:param:xml:ns:xmpp-session'></session></iq></body>";
...
setcookie('boshJid', $test['jid'], 0, '/');
setcookie('boshSid', $test['sid'], 0, '/');
setcookie('boshRid', $test['rid'], 0, '/');
/* } */
?>
